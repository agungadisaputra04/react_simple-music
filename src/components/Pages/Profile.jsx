        ...
        <Container>
            <div className={"Profile"}>
                <div className="top-profile">
                    <Avatar variant={"rounded"} src={require("../assets/img/2.png").default}
                    ...
                    <div className="profile-detail">
                        ...
                        <span className={"profile-playlist"}>
                            <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay}
                                            href={"/home/playlist/chill"} title={"chill"}/>
                            <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/boombap"}
                                            title={"boom bap"}/>
                        </span>
                    </div>
                </div>
